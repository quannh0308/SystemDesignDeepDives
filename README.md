...
next up) · **retail-brokerage** (Trade Republic/Robinhood — live-price
fan-out, buying-power holds, async fills; inherits crypto order routing as a
deep dive) · **matching-engine** (the exchange itself — single-writer order
book, event sourcing, deterministic replay).
