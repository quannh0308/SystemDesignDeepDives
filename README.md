...
|---|---|---|
| [uber-like-rides](./uber-like-rides/design.md) | 🚧 Building (T2/11) | Ride-hailing marketplace: geo matching under a 2M-writes/s location firehose, one-offer-one-driver consistency, burst-proof request queueing |
