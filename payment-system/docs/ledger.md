...
| 2026-09-06 | Grill resolutions: claims-vs-cash added to §1.2 (ledger moves claims; cash moves once, at settlement) + customer-wallet/P2P variant added to §2.3 out-of-scope (balance-sufficiency guard, internal transfers, e-money line) and promoted to NEXT design in BACKLOG.md as p2p-wallet | docs/hld.md §1.2 §2.3, BACKLOG.md, root README | this commit |
